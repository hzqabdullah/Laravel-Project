...
class PostController extends Controller
{
    ...
    public function addPost(Request $request)
    {
        ...
        // return Auth::user(); display in json
        return redirect('/home')->
        with('response', 'Post has been publish successfully');
    }
     ...
     public function editPost(Request $request, $post_id)
    {
        ...
        return redirect('/home')->with('response', 'Post has been updated successfully');
    }
    ...
    public function deletePost($post_id)
    {
        Post::where('id', $post_id)
        ->delete();
        return redirect('/home')->with('response', 'Post has been delete successfully');
    }
