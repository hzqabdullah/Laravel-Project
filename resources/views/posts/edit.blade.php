                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="form-group{{ $errors->has('post_body') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="post_body" rows="5" type="text" class="form-control" name="post_body" required>{{ $posts->post_body }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('post_image') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="post_image" type="file" class="form-control" name="post_image" value="{{ $posts->post_image }}" required>
